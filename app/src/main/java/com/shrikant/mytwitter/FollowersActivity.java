...
public class FollowersActivity extends AppCompatActivity {
    ...
    @Bind(R.id.rvFollowers) RecyclerView mRecyclerViewFollowers;
    @Bind(R.id.toolbar) Toolbar toolbar;
    @Bind(R.id.swipeContainerFollowers) SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerViewFollowers.addItemDecoration(itemDecoration);
    ...
    private void populateFollowers(final boolean isScrolled, final boolean isRefreshed) {
        mTwitterClient.getFollowers(screenName,
