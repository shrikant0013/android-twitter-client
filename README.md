...
**Simple Twitter Clientp** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='http://i.imgur.com/l7DVhCz.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
